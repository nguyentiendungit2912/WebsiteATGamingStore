package com.example.mac.appproject_moneymanager.data;
...
public class DBManager extends SQLiteOpenHelper {
    ...
    public List<Infomation> getInfomationnow(){
        List<Infomation> listInfomation = new ArrayList<>();
        String selectQuery = "SELECT  * FROM " + TABLE_NAME1;
        ...
        if (cursor.moveToFirst()) {
            do {
                Infomation infomation = new Infomation();
                String array1[] = cursor.getString(4).split("/");
                if(array1[1].equals("12")) {
                    infomation.setmID(cursor.getInt(0));
                    infomation.setNumbercost(cursor.getDouble(1));
                    infomation.setGroups(cursor.getString(2));
                    infomation.setNote(cursor.getString(3));
    ...
    public List<Infomation> getInfomationbefore(){
        List<Infomation> listInfomation = new ArrayList<>();
        String selectQuery = "SELECT  * FROM " + TABLE_NAME1;
    ...
    public List<Infomation> getInfomationafter(){
        List<Infomation> listInfomation = new ArrayList<>();
        String selectQuery = "SELECT  * FROM " + TABLE_NAME1;
    ...
    public int updateInfomation(Infomation infomation){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        
        contentValues.put(NUMBERCOST,infomation.getNumbercost());
        contentValues.put(GROUP,infomation.getGroups());
        contentValues.put(NOTE,infomation.getNote());
        contentValues.put(DATE,infomation.getDate());
        contentValues.put(MONEY,infomation.getMoney());
        contentValues.put(WHO,infomation.getHow());
        return db.update(TABLE_NAME1,contentValues,ID+"=?",new String[]{String.valueOf(infomation.getmID())});
    }
